...
<head>
  ...
  <title>Boutique Mactown - Achats des points GIG Etape(2/3)</title>
          ...
          <div id="breadcrumb" class="row breadcrumb">
            <div class="col-md-24">
              ...
              <span class="page-title">Achat</span>
			     <i class="angle-right">&gt;</i>
              <span class="page-title">Etape (2/3)</span>
            </div>
          </div>
        </div>
...
function ShowPaymentForm($id)
{
    if($id == 2)
      {
     echo "<div id='starpass_188693'></div><script type='text/javascript' src='http://script.starpass.fr/script.php?idd=188693&amp;datas='></script><noscript>Veuillez activer le Javascript de votre navigateur s'il vous pla&icirc;t.<br /><a href='http://www.starpass.fr/'>Micropaiement StarPass</a></noscript>";

      }
    else if($id == 4)
      {

echo "<div id='starpass_195157'></div><script type='text/javascript' src='http://script.starpass.fr/script.php?idd=195157&amp;datas='></script><noscript>Veuillez activer le Javascript de votre navigateur s'il vous pla&icirc;t.<br /><a href='http://www.starpass.fr/'>Micropaiement StarPass</a></noscript>";

      }
    else if($id == 10)
      {

echo "<div id='starpass_195158'></div><script type='text/javascript' src='http://script.starpass.fr/script.php?idd=195158&amp;datas='></script><noscript>Veuillez activer le Javascript de votre navigateur s'il vous pla&icirc;t.<br /><a href='http://www.starpass.fr/'>Micropaiement StarPass</a></noscript>";

      }
    else if($id == 20)
      {

echo "<div id='starpass_195159'></div><script type='text/javascript'   src='http://script.starpass.fr/script.php?idd=195159&amp;datas='></script><noscript>Veuillez activer le Javascript de votre navigateur s'il vous pla&icirc;t.<br /><a href='http://www.starpass.fr/'>Micropaiement StarPass</a></noscript>";

      }
    else if($id == 30)
      {

echo "<div id='starpass_195160'></div><script type='text/javascript' src='http://script.starpass.fr/script.php?idd=195160&amp;datas='></script><noscript>Veuillez activer le Javascript de votre navigateur s'il vous pla&icirc;t.<br /><a href='http://www.starpass.fr/'>Micropaiement StarPass</a></noscript>";

      }
    else if($id == 50)
      {
echo "<div id='starpass_188697'></div><script type='text/javascript' src='http://script.starpass.fr/script.php?idd=188697&amp;datas='></script><noscript>Veuillez activer le Javascript de votre navigateur s'il vous pla&icirc;t.<br /><a href='http://www.starpass.fr/'>Micropaiement StarPass</a></noscript>";
      }
setcookie("GIG_VERIFIED", "NO", time()+8200);
}

if(isset($_GET["sid"]) && isset($_COOKIE["GIG_SID"]))
{
if($_GET["sid"] == $_COOKIE["GIG_SID"] )
{
$con = Connect();
$sid = $_COOKIE["GIG_SID"];
$un = "unknown";
$result = mysql_query("SELECT username FROM shop.gig_cmd WHERE sid='$sid'");
...
if($un != "unknown")
{
ShowPaymentForm(  $_GET["pack"]  );
setcookie("GIG_PACK", $_GET["pack"], time()+8200, '/' );
}
else
{
 echo "<br /><span style='color:red'>Cette commande est expiré.</span>";
}
...
{
  echo "<br /><span style='color:red'>Accès refusè.</span>";
}

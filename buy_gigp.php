...
<head>
  ...
  <title>Boutique Mactown - Achats des points GIG</title>
        ...
        <section class="row content">
		  ...
		  <form method="post" action="checkout.php" class="contact-form">
                  ...
                  <ul id="contact-form" class="row list-unstyled">
                    ...
                    <li class="clearfix"></li>
                    <li class="col-md-22">
                      <label class="control-label" for="pack">Pack PG <span class="req">*</span></label>
                     	<select class="element select medium" id="pack" name="pack" autofocus required> 
			<option value="2" selected="selected">Pack 200 points (2 &#8364; HT)</option>	
      		<option value="4" selected="selected">Pack 400 points (4 &#8364; HT)</option>
		      <option value="10" selected="selected">Pack 1000 points (10 &#8364; HT)</option>	
      		<option value="20" selected="selected">Pack 2000 points (20 &#8364; HT)</option>
      		<option value="30" selected="selected">Pack 3000 points (30 &#8364; HT)</option>
	            <option value="50" selected="selected">Pack 5000 points (49 &#8364; HT)</option>
		</select>
                    </li>

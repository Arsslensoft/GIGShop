...
if(intval($type) == 5) 
{
$rescount = GetHouseCount();
}
else if(intval($type) == 6 || intval($type) == 7)
{
$rescount = GetBizzCount(intval($type));
}
else{
$rescount = GetVehicleCount(intval($type));
}
?>
<!doctype html>
...
<head>
  ...
  <title>Boutique Mactown - <?php  echo $typename; ?></title>
      ...
      <div id="content" class="container clearfix">
        <div class="group_breadcrumb">
          <div id="breadcrumb" class="row breadcrumb">
            <div class="col-md-24">
              <a href="./products.php?type=<?php echo $type; ?>" class="homepage-link" title="Back to the frontpage">Products</a>
              <i class="angle-right">&gt;</i>
              <span class="page-title"><?php echo $typename; ?></span>
            </div>
          </div>
        </div>
          ...
          <div id="col-main" class="collection collection-page col-content col-md-19">
            ...
            <div id="page-header">
              <div class="row text-center">
                <h4 id="page-title">Nos <?php  echo $typename; ?></h4>
...
$res = GetAllVehciles(intval($page),intval($type));
if(intval($type) == 5) 
{
$res = GetAllHouses(intval($page));
}
else if(intval($type) == 6 || intval($type) == 7)
{
$res = GetAllBizz(intval($page),intval($type));
}
...
echo '                  <form action="/cart/add" method="post" enctype="multipart/form-data">                <ul class="row-container list-unstyled clearfix">                      <li class="row-left">';
                    ...
                    echo ' <li class="row-right text-left parent-fly animMix"> <div class="group_info">';
                     ...
                     echo '     <br> <a class="col-title" href="">'. $row["category"].'                         </a>                          <p class="hidden-list">';
                      echo  $row["desc"];
...
{
$pager = $page + 1;
echo '			  <li class="next"><a href="products.php?type='.$type.'&page='.$pager.'">Next Page</a></li>';
}			  
			  ?>
              </ul>
